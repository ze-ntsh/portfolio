...
export const fileSystem: FileSystem = {
  ...
  about: {
    description: [
      ...
      "Currently, I'm focusing on leveraging machine learning and artificial intelligence, particularly exploring ways to run resource-intensive Brain Computer Interface ML models efficiently. I aim to improve speed and efficiency, making these models run smoothly in lightweight environments without comprimising performance.",
    ],
  },
  projects: {
    gitfixer: {
      ...
      stack: ["GithubAPI", "Google Cloud Functions", "Firebase", "Next.js", "TailwindCSS"],
      images: [],
      link: "",
      timespan: 2023,
    },
    particlize: {
      ...
      stack: ["TypeScript", "HTML Canvas", "WebGL"],
      images: [],
      link: "",
      timespan: 2024,
    },
    authframe: {
      ...
      stack: ["Next.js", "Lucia-auth", "DrizzleORM", "TailwindCSS"],
      images: [],
      link: "",
      timespan: 2024,
    },
