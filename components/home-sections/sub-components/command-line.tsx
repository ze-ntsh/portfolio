...
export const CLI = () => {
  ...
  return (
    <motion.div
      className={cn("fixed bottom-0 bg-black z-50 w-full", cascadia.className)}
    ...
    >
      {/* control bar */}
      <motion.div
        className="bg-gray-200 w-full h-6 flex items-center"
        style={{
      ...
      >
        <div className="flex gap-2 ml-2">
          <div
            className="h-3.5 aspect-square bg-red-500 rounded-full hover:cursor-pointer"
            onClick={() => {
              setCLIvisible(false);
              setMinimized(false);
            }}
          ></div>
          <div
            className="h-3.5 aspect-square bg-yellow-500 rounded-full hover:cursor-pointer"
            onClick={() => {
              setMinimized((prev) => !prev);
            }}
          ></div>
          <div
            className="h-3.5 aspect-square bg-green-500 rounded-full hover:cursor-pointer"
            onClick={() => {
              setMinimized(false);
            }}
          ></div>
        ...
        <div className="w-full text-center">--terminal--</div>
      ...
      <div
        className="h-full overflow-y-auto pb-10 text-[--text-primary]"
        style={{
          scrollbarWidth: "thin",
        }}
      ...
      >
        ...
        <div className="flex pl-2">
          <span className="">{`nitish@nitish:${dir}$`}</span>
          <input
